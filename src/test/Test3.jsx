...
import WaterOrb from "../components/test/WaterOrb.jsx";
...
export default function EtherealArchPhoto({ src = sceneImg }) {
  ...
  colorC="#8fb4ff"
  glowColor="#c9a6f5"
  cycleMs={6000}   // time between cracks
  holdMs={1200}    // how long the crack/splash lasts
  autoPlay={true}  // set false if you only want it to crack on hover
/>
      </div>
    </div>
  );
